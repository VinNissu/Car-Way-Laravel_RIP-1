...
<section class="col-12  d-flex justify-content-between bg-black cssDoCabecario posicaodocabecario px-5" data-aos="flip-up">
    ...
    <h1 class="col-2 text-light d-flex justify-content-center fs-5 d-none d-lg-block"><a  class="text-decoration-none"href="./upload" target="_blank" rel="noopener noreferrer"><button class="btn btn-light d-flex justify-content-end fs-6 mt-2"></i>Enviar uma foto
    </button></a>
    </h1>

    <h1 class="col-1 text-light d-flex justify-content-center fs-5 d-none d-lg-block"><a class="text-decoration-none" href="/grupo"><button class="btn btn-light d-flex justify-content-end fs-6 mt-2" onclick="modalComu()">Comunidade&nbsp;<i class="fa-solid fa-people-group mt-1"></i></button></a>
    </h1>
...
<div class="container bg-white">
  ...
  <a href="/upload" class="blocoenviarfoto">
...
<?php /**PATH C:\Users\Administrator\Documents\GitHub\Laravel\Composer\car-way\resources\views/feed.blade.php ENDPATH**/ ?>